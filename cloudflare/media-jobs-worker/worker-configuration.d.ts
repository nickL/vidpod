/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface Env` (hash: 9f28978fad2d9adf74f6fea0325d4adc)
// Runtime types generated with workerd@1.20260410.1 2026-04-13 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Mp4ExportJob";
	}
	interface DevEnv {
		MEDIA_JOBS: Queue;
		MP4_EXPORT_JOB: DurableObjectNamespace<import("./src/index").Mp4ExportJob>;
	}
	interface Env {
		MEDIA_JOBS: Queue;
		MP4_EXPORT_JOB: DurableObjectNamespace<import("./src/index").Mp4ExportJob>;
